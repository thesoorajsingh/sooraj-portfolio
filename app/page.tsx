	...
	return (
		<section>
			<h1 className='font-medium text-2xl mb-8 leading-16 font-mono tracking-tight md:flex'>
				...
				<span className='relative h-3 w-3 md:flex xs:flex -top-2 -right-1'>
					<span className='animate-ping absolute inline-flex md:h-full md:w-full rounded-full bg-green-400 opacity-75'></span>
